...
class App extends Component{
	...
	return (
	    ...
	    {this.props.campuses.map( (campus) => <Route exact path={`/AllCampuses/:campusId`} render={(props) => <SingleCampus {...props} campus={campus.id} />} />)}

	    {this.props.allStudents.map( (student) => <Route exact path={`/AllStudents/:studentId`} render={(props) => <SingleStudent {...props} student={student.id} />} />)}
